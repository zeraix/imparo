"""LAB-only Q4_0 x Q8_1 MMQ: K=10240, M=2560, N=512."""
...
@triton.jit
def ip_951d2021de1698086f0d5a89753fb2da8448d43a17a2e01753d9cb7c81039fc6(
    ...
    # The accepted native contraction route uses 30 physical Stream-K workers.
    # Reproduce its one boundary per 128x128 native tile, then fold suffix first
    # at the final add exactly as q4_q8_1_full_tile<..., NumericSeams=true>.
